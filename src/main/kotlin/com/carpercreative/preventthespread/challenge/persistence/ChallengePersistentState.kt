package com.carpercreative.preventthespread.challenge.persistence
...
class ChallengePersistentState(
	...
	companion object {
		...
		fun MinecraftServer.getChallengePersistentState(): ChallengePersistentState {
			return overworld.persistentStateManager.getOrCreate(type, "${PreventTheSpread.MOD_ID}_challenge")
		}
	}
}
