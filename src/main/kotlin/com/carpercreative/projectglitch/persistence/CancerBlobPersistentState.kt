package com.carpercreative.projectglitch.persistence
...
import com.carpercreative.projectglitch.cancer.CancerBlob.Companion.toCancerBlob
import com.carpercreative.projectglitch.persistence.BlobMembershipPersistentState.Companion.getBlobMembershipOrNull
...
class CancerBlobPersistentState : PersistentState() {
	...
	companion object {
		...
		fun MinecraftServer.getCancerBlobPersistentState(): CancerBlobPersistentState {
			return overworld.persistentStateManager.getOrCreate(type, "${ProjectGlitch.MOD_ID}_cancerBlob")
		}
