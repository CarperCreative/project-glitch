...
class DebugToolItem(
	...
	override fun useOnBlock(context: ItemUsageContext): ActionResult {
		...
		return when (debugMode) {
			...
			DebugMode.CREATE_CANCER -> {
				...
				val cancerBlob = CancerLogic.createCancerBlob(world, context.blockPos, incrementDifficulty = context.player?.isSneaking == true)
	...
	companion object {
		private const val KEY_DEBUG_MODE = "${ProjectGlitch.MOD_ID}:debugMode"
