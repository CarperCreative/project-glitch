...
import com.carpercreative.projectglitch.client.ClientStorage
...
class GlitchProgressPacket(
	...
	companion object {
		private val GLITCH_SPREADS_SOUND_EVENT = SoundEvent.of(ProjectGlitch.identifier("glitch_spreads"))
