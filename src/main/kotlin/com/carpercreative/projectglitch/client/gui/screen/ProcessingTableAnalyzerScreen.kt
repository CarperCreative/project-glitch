package com.carpercreative.projectglitch.client.gui.screen
...
class ProcessingTableAnalyzerScreen(
	...
	companion object {
		private val TEXTURE = ProjectGlitch.identifier("textures/gui/container/processing_table_analyzer.png")
		private val EMPTY_PROGRESS_TEXTURE = ProjectGlitch.identifier("container/processing_table_analyzer/progress_empty")
		private val FULL_PROGRESS_TEXTURE = ProjectGlitch.identifier("container/processing_table_analyzer/progress_full")

		private val BOOK_PREVIEW_TITLE_TEXT = Text.translatable("container.${ProjectGlitch.MOD_ID}.processing_table_analyzer.book_preview.title").formatted(Formatting.YELLOW)

		private val hintTooltip = listOf(
			Text.translatable("container.${ProjectGlitch.MOD_ID}.processing_table_analyzer.empty_book_tooltip.0"),
			Text.translatable("container.${ProjectGlitch.MOD_ID}.processing_table_analyzer.empty_book_tooltip.1"),
		)
	}
}
