...
import com.carpercreative.projectglitch.block.CancerLeavesBlock
import com.carpercreative.projectglitch.block.CancerPillarBlock
import com.carpercreative.projectglitch.block.CancerSlabBlock
import com.carpercreative.projectglitch.block.CancerStairsBlock
import com.carpercreative.projectglitch.block.CancerousBlock
import com.carpercreative.projectglitch.block.ChemotherapeuticDrugBlock
import com.carpercreative.projectglitch.block.ChillingTowerBlock
import com.carpercreative.projectglitch.block.ProcessingTableBlock
import com.carpercreative.projectglitch.block.SolidCancerBlock
import com.carpercreative.projectglitch.block.TargetedDrugInjectorBlock
...
import com.carpercreative.projectglitch.challenge.controller.ChallengeStatusController
import com.carpercreative.projectglitch.challenge.controller.ChallengeValidityController
import com.carpercreative.projectglitch.controller.BossBarController
import com.carpercreative.projectglitch.controller.CancerSpreadController
import com.carpercreative.projectglitch.controller.CancerTouchEffectController
import com.carpercreative.projectglitch.controller.ClientStateSynchronizationController
import com.carpercreative.projectglitch.controller.EveryoneTeamController
import com.carpercreative.projectglitch.controller.MessageController
import com.carpercreative.projectglitch.controller.ResearchSynchronizationController
import com.carpercreative.projectglitch.controller.StoryRootUnlockController
...
import com.carpercreative.projectglitch.item.SurgeryAxeItem
import com.carpercreative.projectglitch.item.SurgeryHoeItem
import com.carpercreative.projectglitch.item.SurgeryPickaxeItem
import com.carpercreative.projectglitch.item.SurgeryShovelItem
import com.carpercreative.projectglitch.networking.PerformResearchPacket
import com.carpercreative.projectglitch.screen.ProcessingTableAnalyzerScreenHandler
...
object ProjectGlitch : ModInitializer {
	const val MOD_ID = "projectglitch"
	...
	object StoryAdvancement {
		private fun storyIdentifier(path: String) = ProjectGlitch.identifier("story/$path")

		val ROOT_ID = storyIdentifier("root")
		val OBTAIN_PROBE_ID = storyIdentifier("obtain_probe")
		val OBTAIN_SCANNER_ID = storyIdentifier("obtain_scanner")
	...
	object ResearchAdvancement {
		private fun researchIdentifier(path: String) = ProjectGlitch.identifier("research/$path")
		...
		val CHEMOTHERAPEUTIC_DRUG_ID = researchIdentifier(ProjectGlitch.CHEMOTHERAPEUTIC_DRUG_ID.path)
		val CHEAPER_CHEMOTHERAPEUTIC_DRUG_ID = researchIdentifier("cheaper_${ProjectGlitch.CHEMOTHERAPEUTIC_DRUG_ID.path}")
		val CHEMOTHERAPEUTIC_DRUG_STRENGTH_1_ID = researchIdentifier("${ProjectGlitch.CHEMOTHERAPEUTIC_DRUG_ID.path}_strength_1")
		val CHEMOTHERAPEUTIC_DRUG_STRENGTH_2_ID = researchIdentifier("${ProjectGlitch.CHEMOTHERAPEUTIC_DRUG_ID.path}_strength_2")
		val CHILLING_TOWER_ID = researchIdentifier(ProjectGlitch.CHILLING_TOWER_ID.path)
