...
class ProcessingTableResearchBlockEntity(
	...
	override fun getContainerName(): Text {
		return Text.translatable("container.${ProjectGlitch.MOD_ID}.processing_table_research")
	}
	...
	override fun readNbt(nbt: NbtCompound) {
		val subNbt = nbt.getCompound(ProjectGlitch.PROCESSING_TABLE_RESEARCH_ID.toString())
	...
	override fun writeNbt(nbt: NbtCompound) {
		...
		nbt.put(ProjectGlitch.PROCESSING_TABLE_RESEARCH_ID.toString(), subNbt)
	}
