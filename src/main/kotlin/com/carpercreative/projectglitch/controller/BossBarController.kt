...
object BossBarController {
	private val DANGER_BOSS_BAR_ID = ProjectGlitch.identifier("danger")
	...
	private fun tick(server: MinecraftServer) {
		if (server.ticks % 20 == 6) {
			...
			bossBar.name = Text.translatable("${ProjectGlitch.MOD_ID}.boss_bar_controller.text", (dangerLevel * 100).roundToInt())
